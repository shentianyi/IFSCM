...
ActiveRecord::Schema.define(:version => 20130114040253) do

  create_table "m_delivery_items", :force => true do |t|
    t.string   "key"
    t.integer  "state"
    t.string   "parentKey"
    t.integer  "m_delivery_package_id"
    t.datetime "created_at",            :null => false
    t.datetime "updated_at",            :null => false
  end

  add_index "m_delivery_items", ["m_delivery_package_id"], :name => "index_m_delivery_items_on_m_delivery_package_id"
